...
<form action="Send-managed-form.php" id="paymentform" method="post">
    ...
    <div class="row">
        ...
        <input type="text" name="currency" value="SAR">
    </div>
    ...
    <div class="row">
        <label>phone</label>
        <input type="text" name="phone" value="05000000">
    </div>
    <div class="row">
        <label>street</label>
    ...
    <div class="row">
        <label>State</label>
        <input type="text" name="state" value="Riyadh">
    </div>
    <div class="row">
        <label>city</label>
        <input type="text" name="city" value="Riyadh">
    </div>
    <div class="row">
